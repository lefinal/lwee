...
func (in *ActionInputs) UnmarshalJSON(data []byte) error {
	var err error
	*in, err = lweefile.ParseMapBasedOnType(data, map[ActionInputType]lweefile.Unmarshaller{
		ActionInputTypeContainerWorkspaceFile: lweefile.UnmarshallerFn[ActionInputContainerWorkspaceFile](),
		ActionInputTypeFile:                   lweefile.UnmarshallerFn[ActionInputFile](),
		ActionInputTypeStdin:                  lweefile.UnmarshallerFn[ActionInputStdin](),
		ActionInputTypeStream:                 lweefile.UnmarshallerFn[ActionInputStream](),
	}, "provideAs")
	if err != nil {
...
func (runner *ActionRunner) UnmarshalJSON(data []byte) error {
	var err error
	runner.Runner, err = lweefile.ParseBasedOnType(data, map[ActionRunnerType]lweefile.Unmarshaller{
		ActionRunnerTypeCommand:       lweefile.UnmarshallerFn[ActionRunnerCommand](),
		ActionRunnerTypeImage:         lweefile.UnmarshallerFn[ActionRunnerImage](),
		ActionRunnerTypeProjectAction: lweefile.UnmarshallerFn[ActionRunnerProjectAction](),
	}, "type")
	if err != nil {
...
func (out *ActionOutputs) UnmarshalJSON(data []byte) error {
	var err error
	*out, err = lweefile.ParseMapBasedOnType(data, map[ActionOutputType]lweefile.Unmarshaller{
		ActionOutputTypeContainerWorkspaceFile: lweefile.UnmarshallerFn[ActionOutputContainerWorkspaceFile](),
		ActionOutputTypeStdout:                 lweefile.UnmarshallerFn[ActionOutputStdout](),
		ActionOutputTypeStream:                 lweefile.UnmarshallerFn[ActionOutputStream](),
	}, "providedAs")
	if err != nil {
